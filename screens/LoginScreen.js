...
import {View,Text,TextInput,StyleSheet,
  ...
  export default class LoginScreen extends Component{
      ...
      Login = (emailID,Password)=>{
        ...
        .then(()=>{
            this.props.navigation.navigate('student1nav')
  ...
  teacherlogin = (emailID,Password)=>{
    firebase.auth().signInWithEmailAndPassword(emailID,Password)
    .then(()=>{
        this.props.navigation.navigate('teachernav')
          ...
          
      {
        ...
        <View style={{marginBottom:380}} >
            ...
            />
             ...
             <Text style = {styles.buttontext}>Login(teachers)</Text>
            </TouchableOpacity>
            <TouchableOpacity style = {styles.button}
             onPress = {()=>{this.Login(this.state.emailID,this.state.Password)}}>
             <Text style = {styles.buttontext}>Login(students)</Text>
            </TouchableOpacity>
            <TouchableOpacity style = {styles.button}
